            ...
            <form action="">
                <div class="card-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker" value="{{ Carbon::now('Asia/Ho_Chi_Minh'); }}" name="checkin"/>
                    </div>
            ...
            <form action="">
                <div class="card-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datetimepicker" value="{{ Carbon::now('Asia/Ho_Chi_Minh'); }}" name="checkout"/>
                    </div>
